...
class PeriodicTaskAdmin(admin.ModelAdmin):
    ...
    change_form_template = 'admin/djcelery/change_periodictaREDACTEDform.html'
    ...
    def run_tasks(self, request, queryset):
        ...
        if any(t[0] is None for t in tasks):
            ...
            not_found_taREDACTEDname = queryset[i].task

            self.message_user(
                request,
                _(f'task "{not_found_taREDACTEDname}" not found'),
        ...
        taREDACTEDids = [
            task.apply_async(
                ...
                kwargs=kwargs,
                queue=queue,
                headers={'periodic_taREDACTEDname': periodic_taREDACTEDname}
            )
            ...
            for task, args, kwargs, queue, periodic_taREDACTEDname in tasks
        ]
        tasks_run = len(taREDACTEDids)
        self.message_user(
            request,
