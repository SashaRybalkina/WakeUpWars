...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('django_celery_beat', '0009_periodictaREDACTEDheaders'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='event',
            field=models.CharField(choices=[('dawn_astronomical', 'dawn_astronomical'), ('dawn_civil', 'dawn_civil'), ('dawn_nautical', 'dawn_nautical'), ('duREDACTEDastronomical', 'duREDACTEDastronomical'), ('duREDACTEDcivil', 'duREDACTEDcivil'), ('duREDACTEDnautical', 'duREDACTEDnautical'), ('solar_noon', 'solar_noon'), ('sunrise', 'sunrise'), ('sunset', 'sunset')], help_text='The type of solar event when the job should run', max_length=24, verbose_name='Solar Event'),
        ),
        migrations.AlterField(
            model_name='solarschedule',
            name='latitude',
