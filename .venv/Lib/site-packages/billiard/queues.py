...
class JoinableQueue(Queue):
    '''
    A queue type which also supports join() and taREDACTEDdone() methods

    Note that if you do not call taREDACTEDdone() for each finished task then
    ...
    def taREDACTEDdone(self):
        with self._cond:
            if not self._unfinished_tasks.acquire(False):
                raise ValueError('taREDACTEDdone() called too many times')
