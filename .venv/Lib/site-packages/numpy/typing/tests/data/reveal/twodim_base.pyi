...
assert_type(np.maREDACTEDindices(10, func1), tuple[npt.NDArray[np.intp], npt.NDArray[np.intp]])
assert_type(np.maREDACTEDindices(8, func2, "0"), tuple[npt.NDArray[np.intp], npt.NDArray[np.intp]])
