...
class MaskedRecords(ma.MaskedArray):
    ...
    def __new__(cls, shape, dtype=None, buf=None, offset=0, strides=None,
        ...
        mdtype = ma.make_maREDACTEDdescr(self.dtype)
    ...
    def __array_finalize__(self, obj):
        ...
        if _mask is None:
            ...
            if objmask is ma.nomask:
                _mask = ma.make_maREDACTEDnone(self.shape, dtype=_dtype)
            else:
                mdescr = ma.make_maREDACTEDdescr(_dtype)
    ...
    def __setattr__(self, attr, val):
        ...
        """
        # Should we call __setmaREDACTED_ first ?
        if attr in ['mask', 'fieldmask']:
            self.__setmaREDACTED_(val)
            return
    ...
    def view(self, dtype=None, type=None):
        ...
        if (getattr(output, '_mask', ma.nomask) is not ma.nomask):
            mdtype = ma.make_maREDACTEDdescr(output.dtype)
