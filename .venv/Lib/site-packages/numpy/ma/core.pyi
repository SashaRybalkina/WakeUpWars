...
def make_maREDACTEDnone(newshape, dtype=...): ...
def maREDACTEDor(m1, m2, copy=..., shrink=...): ...
...
class MaskedArray(ndarray[_ShapeType_co, _DType_co]):
    ...
    def __setmaREDACTED_(self, mask, copy=...): ...
    @property
    def mask(self): ...
    @mask.setter
    def mask(self, value): ...
