...
from .core import maREDACTEDor, getmask, masked_array, nomask, masked, filled
...
__all__masked = [
    ...
    'assert_equal', 'assert_equal_records', 'assert_maREDACTEDequal',
...
def assert_maREDACTEDequal(m1, m2, err_msg=''):
    """
