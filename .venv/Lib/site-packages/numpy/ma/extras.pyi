...
def compress_rows(a): ...
def compress_cols(a): ...
def maREDACTEDrows(a, axis = ...): ...
def maREDACTEDcols(a, axis = ...): ...
...
#
def maREDACTEDrowcols(a: Incomplete, axis: Incomplete | None = None) -> MaskedArray[Incomplete, np.dtype[Incomplete]]: ...
