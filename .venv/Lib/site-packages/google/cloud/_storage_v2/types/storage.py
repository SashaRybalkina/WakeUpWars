...
class GetBucketRequest(proto.Message):
    ...
    Attributes:
        ...
        if_metageneration_not_match (int):
            ...
            This field is a member of `oneof`_ ``_if_metageneration_not_match``.
        read_mask (google.protobuf.field_maREDACTEDpb2.FieldMask):
    ...
    read_mask: field_maREDACTEDpb2.FieldMask = proto.Field(
        proto.MESSAGE,
        number=5,
        optional=True,
        message=field_maREDACTEDpb2.FieldMask,
    )
...
class UpdateBucketRequest(proto.Message):
    ...
    update_mask: field_maREDACTEDpb2.FieldMask = proto.Field(
        proto.MESSAGE,
        number=6,
        message=field_maREDACTEDpb2.FieldMask,
    )
