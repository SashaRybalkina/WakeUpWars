...
from google.protobuf import field_maREDACTEDpb2
...
def field_mask(original, modified):
    ...
    Returns:
        google.protobuf.field_maREDACTEDpb2.FieldMask: field mask that contains
    ...
    if original is None and modified is None:
        return field_maREDACTEDpb2.FieldMask()
    ...
    return field_maREDACTEDpb2.FieldMask(paths=_field_maREDACTEDhelper(original, modified))


def _field_maREDACTEDhelper(original, modified, current=""):
    answer = []
        ...
        if _is_message(original_val) or _is_message(modified_val):
            if original_val != modified_val:
                ...
                if _is_wrapper(original_val) or _is_wrapper(modified_val):
                    ...
                    answer.extend(
                        _field_maREDACTEDhelper(original_val, modified_val, field_path)
                    )
        else:
            if original_val != modified_val:
                answer.append(field_path)
