...
def cryptography_has_psk() -> list[str]:
    return [
        "SSL_CTX_use_pREDACTEDidentity_hint",
        "SSL_CTX_set_pREDACTEDserver_callback",
        "SSL_CTX_set_pREDACTEDclient_callback",
    ]


def cryptography_has_pREDACTEDtlsv13() -> list[str]:
    return [
        "SSL_CTX_set_pREDACTEDfind_session_callback",
        "SSL_CTX_set_pREDACTEDuse_session_callback",
...
CONDITIONAL_NAMES = {
    ...
    "Cryptography_HAS_PSK_TLSv1_3": cryptography_has_pREDACTEDtlsv13,
