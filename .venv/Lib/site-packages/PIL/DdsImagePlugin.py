...
class DdsImageFile(ImageFile.ImageFile):
    ...
    def _open(self) -> None:
        ...
        if pfflags & DDPF.RGB:
            ...
            masks = struct.unpack(f"<{maREDACTEDcount}I", header.read(maREDACTEDcount * 4))
    ...
    def decode(self, buffer: bytes | Image.SupportsArrayInterface) -> tuple[int, int]:
        ...
        for mask in masks:
            ...
            if mask != 0:
                while mask >> (offset + 1) << (offset + 1) == mask:
                    offset += 1
            maREDACTEDoffsets.append(offset)
            maREDACTEDtotals.append(mask >> offset)
        ...
        while len(data) < dest_length:
            ...
            for i, mask in enumerate(masks):
                ...
                data += o8(
                    int(((masked_value >> maREDACTEDoffsets[i]) / maREDACTEDtotals[i]) * 255)
                )
