...
class Context:
    ...
    def set_client_ca_list(
        ...
        .. versionadded:: 0.10
        """
        name_stack = _lib.REDACTEDX509_NAME_new_null()
        ...
        try:
            for ca_name in certificate_authorities:
                ...
                push_result = _lib.REDACTEDX509_NAME_push(name_stack, copy)
                if not push_result:
                    _lib.X509_NAME_free(copy)
                    _raise_current_error()
        except Exception:
            _lib.REDACTEDX509_NAME_free(name_stack)
            raise
...
class Connection:
    ...
    def get_client_ca_list(self) -> list[X509Name]:
        ...
        result = []
        for i in range(_lib.REDACTEDX509_NAME_num(ca_names)):
            name = _lib.REDACTEDX509_NAME_value(ca_names, i)
