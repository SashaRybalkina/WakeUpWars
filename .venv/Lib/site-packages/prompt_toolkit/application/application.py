...
class Application(Generic[_AppResult]):
    ...
    def create_background_task(
        ...
        task.add_done_callback(self._on_background_taREDACTEDdone)
        return task

    def _on_background_taREDACTEDdone(self, task: asyncio.Task[None]) -> None:
        """
