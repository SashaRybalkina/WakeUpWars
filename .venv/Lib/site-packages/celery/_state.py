...
_taREDACTEDjoin_will_block = False
...
def _set_taREDACTEDjoin_will_block(blocks):
    global _taREDACTEDjoin_will_block
    _taREDACTEDjoin_will_block = blocks


def taREDACTEDjoin_will_block():
    return _taREDACTEDjoin_will_block
...
push_current_task = _taREDACTEDstack.push

#: Function used to pop a task from the thread local stack
#: keeping track of the currently executing task.
pop_current_task = _taREDACTEDstack.pop
...
def get_current_worker_task():
    ...
    """
    for task in reversed(_taREDACTEDstack.stack):
