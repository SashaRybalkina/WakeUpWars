...
class Tasks(bootsteps.StartStopStep):
    ...
    def __init__(self, c, **kwargs):
        c.taREDACTEDconsumer = c.qos = None
    ...
    def start(self, c):
        ...
        c.taREDACTEDconsumer = c.app.amqp.TaskConsumer(
            c.connection, on_decode_error=c.on_decode_error,
        )

        def set_prefetch_count(prefetch_count):
            return c.taREDACTEDconsumer.qos(
    ...
    def stop(self, c):
        """Stop task consumer."""
        if c.taREDACTEDconsumer:
            debug('Canceling task consumer...')
            ignore_errors(c, c.taREDACTEDconsumer.cancel)
    ...
    def shutdown(self, c):
        ...
        if c.taREDACTEDconsumer:
            ...
            ignore_errors(c, c.taREDACTEDconsumer.close)
            c.taREDACTEDconsumer = None
