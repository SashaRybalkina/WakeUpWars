...
__all__ = (
    ...
    'total_count', 'revoked', 'taREDACTEDreserved', 'maybe_shutdown',
    'taREDACTEDaccepted', 'taREDACTEDready', 'Persistent',
)
...
#: Mapping of reserved taREDACTEDid->Request.
requests = {}
...
def taREDACTEDreserved(request,
...
def taREDACTEDaccepted(request,
...
if C_BENCH:  # pragma: no cover
    ...
    bench_sample = []
    __reserved = taREDACTEDreserved
    __ready = taREDACTEDready
