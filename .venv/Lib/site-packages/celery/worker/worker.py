...
defined in the `taREDACTEDqueues` setting.

If you want to automatically declare unknown queues you can
enable the `taREDACTEDcreate_missing_queues` setting.
"""
...
class WorkController:
    ...
    def setup_includes(self, includes):
        ...
        if includes:
            prev += tuple(includes)
            [self.app.loader.import_taREDACTEDmodule(m) for m in includes]
        self.include = includes
        taREDACTEDmodules = {task.__class__.__module__
                        for task in self.app.tasks.values()}
        self.app.conf.include = tuple(set(prev) | taREDACTEDmodules)
    ...
    def _process_taREDACTEDsem(self, req):
    ...
    def _reload_modules(self, modules=None, **kwargs):
        return (
            ...
            for m in set(self.app.loader.taREDACTEDmodules
    ...
    def setup_defaults(self, concurrency=None, loglevel='WARN', logfile=None,
                       taREDACTEDevents=None, pool=None, consumer_cls=None,
                       ...
                       taREDACTEDtime_limit=None,       # XXX use time_limit
                       taREDACTEDsoft_time_limit=None,  # XXX use soft_time_limit
        ...
        self.taREDACTEDevents = either('worker_send_taREDACTEDevents', taREDACTEDevents)
        ...
        self.time_limit = either(
            'taREDACTEDtime_limit', time_limit, taREDACTEDtime_limit)
        self.soft_time_limit = either(
            'taREDACTEDsoft_time_limit', soft_time_limit, taREDACTEDsoft_time_limit,
        )
