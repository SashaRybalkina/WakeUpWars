...
from celery._state import _set_taREDACTEDjoin_will_block
    ...
    def create(self, w):
        ...
        if not threaded:
            ...
            if w.pool_putlocks and w.pool_cls.uses_semaphore:
                w.process_task = w._process_taREDACTEDsem
        ...
        _set_taREDACTEDjoin_will_block(pool.taREDACTEDjoin_will_block)
        return pool
...
class Consumer(bootsteps.StartStopStep):
    ...
    def create(self, w):
        ...
        c = w.consumer = self.instantiate(
            ...
            hostname=w.hostname,
            taREDACTEDevents=w.taREDACTEDevents,
