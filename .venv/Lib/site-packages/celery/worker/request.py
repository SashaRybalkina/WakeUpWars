...
from celery.app.trace import fast_trace_task, trace_task, trace_taREDACTEDret
...
send_revoked = signals.taREDACTEDrevoked.send
send_retry = signals.taREDACTEDretry.send

taREDACTEDaccepted = state.taREDACTEDaccepted
taREDACTEDready = state.taREDACTEDready
...
class Request:
    ...
    @taREDACTEDid.setter
    def taREDACTEDid(self, value):
        self.id = value

    @property
    def taREDACTEDname(self):
        # XXX compat
        return self.name

    @taREDACTEDname.setter
    def taREDACTEDname(self, value):
        self.name = value
    ...
    @property
    def replaced_taREDACTEDnesting(self):
        return self._request_dict.get('replaced_taREDACTEDnesting', 0)
    ...
    def execute_using_pool(self, pool: BasePool, **kwargs):
        ...
        task = self._task
        if self.revoked():
            raise TaskRevokedError(taREDACTEDid)

        time_limit, soft_time_limit = self.time_limits
        trace = fast_trace_task if self._app.use_fast_trace_task else trace_taREDACTEDret
        result = pool.apply_async(
            trace,
            args=(self._type, taREDACTEDid, self._request_dict, self._body,
                  self._content_type, self._content_encoding),
    ...
    def on_success(self, failed__retval__runtime, **kwargs):
        ...
        taREDACTEDready(self, successful=True)
    ...
    def on_failure(self, exc_info, send_failed_event=True, return_ok=False):
        ...
        if not requeue and (is_worker_lost or not return_ok):
            ...
            signals.taREDACTEDfailure.send(sender=self.task, taREDACTEDid=self.id,
...
def create_request_cls(base, task, pool, hostname, eventer,
                       ...
                       taREDACTEDready=taREDACTEDready, trace=None, app=current_app):
    ...
    if trace is None:
        trace = fast_trace_task if app.use_fast_trace_task else trace_taREDACTEDret
    ...
    class Request(base):
        ...
        def execute_using_pool(self, pool, **kwargs):
            ...
            result = apply_async(
                trace,
                args=(self.type, taREDACTEDid, self.request_dict, self.body,
