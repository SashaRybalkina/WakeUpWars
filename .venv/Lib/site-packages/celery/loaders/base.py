...
class BaseLoader:
    ...
    def on_taREDACTEDinit(self, taREDACTEDid, task):
    ...
    def import_taREDACTEDmodule(self, module):
        self.taREDACTEDmodules.add(module)
    ...
    def import_default_modules(self):
        ...
        for _, response in responses:
            if isinstance(response, Exception):
                raise response
        return [self.import_taREDACTEDmodule(m) for m in self.default_modules]
