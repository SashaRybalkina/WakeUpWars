...
from celery.result import _set_taREDACTEDjoin_will_block, allow_join_result
...
def start_worker(
    ...
    ping_taREDACTEDtimeout=10.0,  # type: float
        ...
        with _start_worker_thread(app,
            ...
            if perform_ping_check:
                ...
                with allow_join_result():
                    assert ping.delay().get(timeout=ping_taREDACTEDtimeout) == 'pong'
