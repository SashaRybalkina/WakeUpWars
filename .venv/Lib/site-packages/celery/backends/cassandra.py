...
Q_INSERT_RESULT = """
INSERT INTO {table} (
    taREDACTEDid, status, result, date_done, traceback, children) VALUES (
        %s, %s, %s, %s, %s, %s) {expires};
"""
...
CREATE TABLE {table} (
    ...
    traceback blob,
    children blob,
    PRIMARY KEY ((taREDACTEDid), date_done)
...
class CassandraBackend(BaseBackend):
    ...
    def _store_result(self, taREDACTEDid, result, state,
        ...
        self._session.execute(self._write_stmt, (
            ...
            buf_t(self.encode(self.current_taREDACTEDchildren(request)))
        ))
    ...
    def _get_taREDACTEDmeta_for(self, taREDACTEDid):
        ...
        res = self._session.execute(self._read_stmt, (taREDACTEDid, )).one()
        if not res:
