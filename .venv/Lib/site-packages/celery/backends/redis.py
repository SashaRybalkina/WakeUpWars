...
from celery._state import taREDACTEDjoin_will_block
...
class ResultConsumer(BaseResultConsumer):
    ...
    def _maybe_cancel_ready_task(self, meta):
        if meta['status'] in states.READY_STATES:
            self.cancel_for(meta['taREDACTEDid'])
    ...
    def start(self, initial_taREDACTEDid, **kwargs):
        ...
        self._consume_from(initial_taREDACTEDid)
    ...
    def consume_from(self, taREDACTEDid):
        ...
        self._consume_from(taREDACTEDid)

    def _consume_from(self, taREDACTEDid):
        key = self._get_key_for_task(taREDACTEDid)
...
class RedisBackend(BaseKeyValueStoreBackend, AsyncBackendMixin):
    ...
    def forget(self, taREDACTEDid):
        super().forget(taREDACTEDid)
        self.result_consumer.cancel_for(taREDACTEDid)
