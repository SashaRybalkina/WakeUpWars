...
class DjangoFixup:
    ...
    def install(self) -> "DjangoFixup":
        ...
        if not self.app._custom_taREDACTEDcls_used:
            self.app.taREDACTEDcls = 'celery.contrib.django.task:DjangoTask'
...
class DjangoWorkerFixup:
    ...
    def install(self) -> "DjangoWorkerFixup":
        ...
        signals.taREDACTEDprerun.connect(self.on_taREDACTEDprerun)
        signals.taREDACTEDpostrun.connect(self.on_taREDACTEDpostrun)
    ...
    def on_taREDACTEDprerun(self, sender: "Task", **kwargs: Any) -> None:
        """Called before every task."""
        if not getattr(sender.request, 'is_eager', False):
            self.close_database()

    def on_taREDACTEDpostrun(self, sender: "Task", **kwargs: Any) -> None:
