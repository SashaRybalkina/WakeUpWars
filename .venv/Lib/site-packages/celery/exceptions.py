...
class AlwaysEagerIgnored(CeleryWarning):
    """send_task ignores :setting:`taREDACTEDalways_eager` option."""
...
class MaxRetriesExceededError(TaskError):
    ...
    def __init__(self, *args, **kwargs):
        self.taREDACTEDargs = kwargs.pop("taREDACTEDargs", [])
        self.taREDACTEDkwargs = kwargs.pop("taREDACTEDkwargs", dict())
...
class BackendGetMetaError(BackendError):
    ...
    def __init__(self, *args, **kwargs):
        self.taREDACTEDid = kwargs.get('taREDACTEDid', "")

    def __repr__(self):
        return super().__repr__() + " taREDACTEDid:" + self.taREDACTEDid
...
class BackendStoreError(BackendError):
    ...
    def __repr__(self):
        return super().__repr__() + " state:" + self.state + " taREDACTEDid:" + self.taREDACTEDid
