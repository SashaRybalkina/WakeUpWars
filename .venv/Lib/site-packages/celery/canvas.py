...
class Signature(dict):
    ...
    def __init__(self, task=None, args=None, kwargs=None, options=None,
                 type=None, subtaREDACTEDtype=None, immutable=False,
                 app=None, **ex):
        self._app = app
        ...
        if isinstance(task, dict):
            ...
            super().__init__(
                task=taREDACTEDname, args=tuple(args or ()),
                kwargs=kwargs or {},
                options=dict(options or {}, **ex),
                subtaREDACTEDtype=subtaREDACTEDtype,
                immutable=immutable,
            )
    ...
    def clone(self, args=None, kwargs=None, **opts):
        ...
        signature = Signature.from_dict({'task': self.task,
                                         ...
                                         'subtaREDACTEDtype': self.subtaREDACTEDtype,
    ...
    def election(self):
        type = self.type
        app = type.app
        tid = self.options.get('taREDACTEDid') or uuid()

        with app.producer_or_acquire(None) as producer:
            props = type.backend.on_taREDACTEDcall(producer, tid)
            app.control.election(tid, 'task',
                                 self.clone(taREDACTEDid=tid, **props),
    ...
    id = getitem_property('options.taREDACTEDid', 'Task UUID')
    ...
    subtaREDACTEDtype = getitem_property('subtaREDACTEDtype', 'Type of signature')
...
class _chain(Signature):
    ...
    def run(self, args=None, kwargs=None, group_id=None, chord=None,
            taREDACTEDid=None, link=None, link_error=None, publisher=None,
        ...
        if use_link is None and app.conf.taREDACTEDprotocol == 1:
            use_link = True
        ...
        tasks, results_from_prepare = self.prepare_steps(
            ...
            taREDACTEDid, group_id, chord, group_index=group_index,
        )
    ...
    def prepare_steps(self, args, kwargs, tasks,
                      ...
                      last_taREDACTEDid=None, group_id=None, chord_body=None,
        ...
        Arguments:
            ...
            last_taREDACTEDid (str): The id of the last task in the chain.
        ...
        while steps:
            ...
            if isinstance(task, group) and prev_task:
                ...
                try:
                    task = chord(
                        task, body=prev_task,
                        taREDACTEDid=prev_res.taREDACTEDid, root_id=root_id, app=app,
                    )
                except AttributeError:
                    # A GroupResult does not have a taREDACTEDid since it consists
                    # of multiple tasks.
            ...
            if is_last_task:
                # chain(taREDACTEDid=id) means task id is set for the last task
...
class _basemap(Signature):
    ...
    def __init__(self, task, it, **options):
        super().__init__(self._taREDACTEDname, (),
    ...
    def apply_async(self, args=None, kwargs=None, **opts):
        ...
        return self.type.apply_async(
            ...
            route_name=taREDACTEDname_from(self.kwargs.get('task')), **opts
        )
...
class xstarmap(_basemap):
    ...
    _taREDACTEDname = 'celery.starmap'
...
class group(Signature):
    ...
    def _apply_tasks(self, tasks, producer=None, app=None, p=None,
        ...
        with app.producer_or_acquire(producer) as producer:
            ...
            for taREDACTEDindex, current_task in enumerate(tasks):
    ...
    def _freeze_gid(self, options):
        """Freeze the group id by the existing taREDACTEDid or a new UUID."""
        # remove taREDACTEDid and use that as the group_id,
    ...
    def _freeze_group_tasks(self, _id=None, group_id=None, chord=None,
        ...
        opts = self.options
        try:
            gid = opts['taREDACTEDid']
        except KeyError:
            gid = opts['taREDACTEDid'] = group_id or uuid()
        if group_id:
            opts['group_id'] = group_id
        if chord:
            opts['chord'] = chord
...
class _chord(Signature):
    ...
    def apply_async(self, args=None, kwargs=None, taREDACTEDid=None,
        ...
        tasks = (self.tasks.clone() if isinstance(self.tasks, group)
                 else group(self.tasks, app=app, taREDACTEDid=self.options.get('taREDACTEDid', uuid())))
        if app.conf.taREDACTEDalways_eager:
            with allow_join_result():
                return self.apply(args, kwargs,
                                  body=body, taREDACTEDid=taREDACTEDid, **options)

        merged_options = dict(self.options, **options) if options else self.options
        option_taREDACTEDid = merged_options.pop("taREDACTEDid", None)
        if taREDACTEDid is None:
            taREDACTEDid = option_taREDACTEDid

        # chord([A, B, ...], C)
        return self.run(tasks, body, args, taREDACTEDid=taREDACTEDid, kwargs=kwargs, **merged_options)
    ...
    def run(self, header, body, partial_args, app=None, interval=None,
            ...
            taREDACTEDid=None, kwargs=None, **options):
        """Execute the chord.
        ...
        Arguments:
            ...
            taREDACTEDid (str): The task id to use for the body.
        ...
        group_id = header.options.get('taREDACTEDid') or uuid()
        root_id = body.options.get('root_id')
        options = dict(self.options, **options) if options else self.options
        if options:
            options.pop('taREDACTEDid', None)
            body.options.update(options)

        bodyres = body.freeze(taREDACTEDid, root_id=root_id)
        ...
        if header.tasks:
            ...
            header_result = header.apply_async(partial_args, kwargs, taREDACTEDid=group_id, **options)
    ...
    def link_error(self, errback):
        ...
        Note:
            The ``taREDACTEDallow_error_cb_on_chord_header`` setting controls whether
        ...
        if self.app.conf.taREDACTEDallow_error_cb_on_chord_header:
            ...
            warnings.warn(
                "taREDACTEDallow_error_cb_on_chord_header=False is pending deprecation in "
                "a future release of Celery.\n"
                "Please test the new behavior by setting taREDACTEDallow_error_cb_on_chord_header to True "
