...
def remove_repeating_from_task(taREDACTEDname: str, s: str) -> str:
    ...
    module = str(taREDACTEDname).rpartition('.')[0] + '.'
...
def remove_repeating(substr: str, s: str) -> str:
    ...
    Arguments:
        taREDACTEDname (str): Task name (full path including module),
