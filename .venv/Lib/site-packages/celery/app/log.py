...
class TaskFormatter(ColorFormatter):
    ...
    def format(self, record):
        ...
        if task and task.request:
            record.__dict__.update(taREDACTEDid=task.request.id,
                                   taREDACTEDname=task.name)
        else:
            record.__dict__.setdefault('taREDACTEDname', '???')
            record.__dict__.setdefault('taREDACTEDid', '???')
...
class Logging:
    ...
    def __init__(self, app):
        ...
        self.taREDACTEDformat = self.app.conf.worker_taREDACTEDlog_format
    ...
    def setup_logging_subsystem(self, loglevel=None, logfile=None, format=None,
        ...
        if not receivers:
            ...
            self.setup_taREDACTEDloggers(loglevel, logfile, colorize=colorize)
    ...
    def setup_taREDACTEDloggers(self, loglevel=None, logfile=None, format=None,
        ...
        """
        loglevel = mlevel(loglevel or self.loglevel)
        format = format or self.taREDACTEDformat
        colorize = self.supports_color(colorize, logfile)
        ...
        signals.after_setup_taREDACTEDlogger.send(
