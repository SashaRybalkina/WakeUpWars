...
%(taREDACTEDname)s[%(taREDACTEDid)s]: %(message)s"""
...
NAMESPACES = Namespace(
    ...
    result=Namespace(
        ...
        expires=Option(
            timedelta(days=1),
            type='float', old={'celery_taREDACTEDresult_expires'},
        ),
    ...
    task=Namespace(
        ...
        protocol=Option(2, type='int', old={'celery_taREDACTEDprotocol'}),
        publish_retry=Option(
            True, type='bool', old={'celery_taREDACTEDpublish_retry'},
        ),
        publish_retry_policy=Option(
            {'max_retries': 3,
             ...
             'interval_max': 1,
             'interval_step': 0.2},
            type='dict', old={'celery_taREDACTEDpublish_retry_policy'},
        ),
        ...
        send_sent_event=Option(
            False, type='bool', old={'celery_send_taREDACTEDsent_event'},
        ),
        serializer=Option('json', old={'celery_taREDACTEDserializer'}),
        soft_time_limit=Option(
            type='float', old={'celeryd_taREDACTEDsoft_time_limit'},
        ),
        time_limit=Option(
            type='float', old={'celeryd_taREDACTEDtime_limit'},
        ),
    ...
    worker=Namespace(
        ...
        send_taREDACTEDevents=Option(
            False, type='bool', old={'celery_send_events'},
        ),
        state_db=Option(),
        taREDACTEDlog_format=Option(DEFAULT_TASK_LOG_FMT),
