...
from celery._state import _taREDACTEDstack
...
from .registry import _unpickle_taREDACTEDv2
...
class Context:
    ...
    def as_execution_options(self):
        ...
        execution_options = {
            ...
            'replaced_taREDACTEDnesting': self.replaced_taREDACTEDnesting,
            'origin': self.origin,
        }
...
class Task:
    ...
    #: for this task.  Defaults to the :setting:`taREDACTEDignore_result`
    #: setting.
    ignore_result = None
    ...
    #: Hard time limit.
    #: Defaults to the :setting:`taREDACTEDtime_limit` setting.
    time_limit = None

    #: Soft time limit.
    #: Defaults to the :setting:`taREDACTEDsoft_time_limit` setting.
    ...
    #: :setting:`taREDACTEDtrack_started` setting.
    track_started = None
    ...
    #: :setting:`taREDACTEDacks_late` setting.
    acks_late = None
    ...
    #: :setting:`taREDACTEDacks_late` is enabled.
    #:
    #: The application default can be overridden with the
    #: :setting:`taREDACTEDacks_on_failure_or_timeout` setting.
    ...
    from_config = (
        ('serializer', 'taREDACTEDserializer'),
        ('rate_limit', 'taREDACTEDdefault_rate_limit'),
        ('priority', 'taREDACTEDdefault_priority'),
        ('track_started', 'taREDACTEDtrack_started'),
        ('acks_late', 'taREDACTEDacks_late'),
        ('acks_on_failure_or_timeout', 'taREDACTEDacks_on_failure_or_timeout'),
        ('reject_on_worker_lost', 'taREDACTEDreject_on_worker_lost'),
        ('ignore_result', 'taREDACTEDignore_result'),
        ('store_eager_result', 'taREDACTEDstore_eager_result'),
        ('store_errors_even_if_ignored', 'taREDACTEDstore_errors_even_if_ignored'),
    )
    ...
    def __call__(self, *args, **kwargs):
        _taREDACTEDstack.push(self)
        self.push_request(args=args, kwargs=kwargs)
        try:
            return self.run(*args, **kwargs)
        finally:
            self.pop_request()
            _taREDACTEDstack.pop()
    ...
    def __reduce__(self):
        ...
        return (_unpickle_taREDACTEDv2, (self.name, mod), None)
    ...
    def apply_async(self, args=None, kwargs=None, taREDACTEDid=None, producer=None,
        ...
        Arguments:
            ...
            retry (bool): If enabled sending of the task message will be
                ...
                Default is taken from the :setting:`taREDACTEDpublish_retry`
                setting.  Note that you need to handle the
                producer/connection manually for this to work.

            retry_policy (Mapping): Override the retry policy used.
                See the :setting:`taREDACTEDpublish_retry_policy` setting.
            ...
            queue (str, kombu.Queue): The queue to route the task to.
                This must be a key present in :setting:`taREDACTEDqueues`, or
                :setting:`taREDACTEDcreate_missing_queues` must be
            ...
            compression (str): Optional compression method
                ...
                Defaults to the :setting:`taREDACTEDcompression` setting.
        ...
        app = self._get_app()
        if app.conf.taREDACTEDalways_eager:
            with app.producer_or_acquire(producer) as eager_producer:
                ...
                if serializer is None:
                    if eager_producer.serializer:
                        ...
                        serializer = app.conf.taREDACTEDserializer
                body = args, kwargs
            ...
            with denied_join_result():
                return self.apply(args, kwargs, taREDACTEDid=taREDACTEDid or uuid(),
                                  link=link, link_error=link_error, **options)
        else:
            return app.send_task(
                self.name, args, kwargs, taREDACTEDid=taREDACTEDid, producer=producer,
                link=link, link_error=link_error, result_cls=self.AsyncResult,
                shadow=shadow, taREDACTEDtype=self,
                **options
            )
    ...
    subtaREDACTEDfrom_request = signature_from_request  # XXX compat
    ...
    def retry(self, args=None, kwargs=None, exc=None, throw=True,
        ...
        if max_retries is not None and retries > max_retries:
            ...
            raise self.MaxRetriesExceededError(
                ...
                ), taREDACTEDargs=S.args, taREDACTEDkwargs=S.kwargs
            )
    ...
    def apply(self, args=None, kwargs=None,
              ...
              taREDACTEDid=None, retries=None, throw=None,
        ...
        Arguments:
            ...
            throw (bool): Re-raise task exceptions.
                Defaults to the :setting:`taREDACTEDeager_propagates` setting.
        ...
        args = args or ()
        kwargs = kwargs or {}
        taREDACTEDid = taREDACTEDid or uuid()
        retries = retries or 0
        if throw is None:
            throw = app.conf.taREDACTEDeager_propagates
        ...
        ret = tracer(taREDACTEDid, args, kwargs, request)
        retval = ret.retval
        ...
        return EagerResult(taREDACTEDid, retval, state, traceback=tb, name=self.name)

    def AsyncResult(self, taREDACTEDid, **kwargs):
        """Get AsyncResult instance for the specified task.

        Arguments:
            taREDACTEDid (str): Task id to get result for.
        """
        return self._get_app().AsyncResult(taREDACTEDid, backend=self.backend,
                                           taREDACTEDname=self.name, **kwargs)
    ...
    def send_event(self, type_, retry=True, retry_policy=None, **fields):
        ...
        Keyword Arguments:
            retry (bool):  Retry sending the message
                ...
                :setting:`taREDACTEDpublish_retry` setting.
            retry_policy (Mapping): Retry settings.  Default is taken
                from the :setting:`taREDACTEDpublish_retry_policy` setting.
            **fields (Any): Map containing information about the event.
                Must be JSON serializable.
        """
        req = self.request
        if retry_policy is None:
            retry_policy = self.app.conf.taREDACTEDpublish_retry_policy
    ...
    def replace(self, sig):
        ...
        if isinstance(sig, _chain) and "link" in sig.options:
            final_taREDACTEDlinks = sig.tasks[-1].options.setdefault("link", [])
            final_taREDACTEDlinks.extend(maybe_list(sig.options["link"]))
        ...
        replaced_taREDACTEDnesting = self.request.get('replaced_taREDACTEDnesting', 0) + 1
        sig.set(
            chord=chord,
            group_id=self.request.group,
            group_index=self.request.group_index,
            root_id=self.request.root_id,
            replaced_taREDACTEDnesting=replaced_taREDACTEDnesting
        )

        # If the replaced task is a chain, we want to set all of the chain tasks
        # with the same replaced_taREDACTEDnesting value to mark their replacement nesting level
        if isinstance(sig, _chain):
            for chain_task in maybe_list(sig.tasks) or []:
                chain_task.set(replaced_taREDACTEDnesting=replaced_taREDACTEDnesting)
    ...
    def update_state(self, taREDACTEDid=None, state=None, meta=None, **kwargs):
        """Update task state.

        Arguments:
            taREDACTEDid (str): Id of the task to update.
                Defaults to the id of the current task.
            state (str): New state.
            meta (Dict): State meta-data.
        """
        if taREDACTEDid is None:
            taREDACTEDid = self.request.id
        self.backend.store_result(
            taREDACTEDid, meta, state, request=self.request, **kwargs)

    def before_start(self, taREDACTEDid, args, kwargs):
        """Handler called before the task starts.

        .. versionadded:: 5.2

        Arguments:
            taREDACTEDid (str): Unique id of the task to execute.
    ...
    def on_success(self, retval, taREDACTEDid, args, kwargs):
        """Success handler.
        ...
        Arguments:
            ...
            taREDACTEDid (str): Unique id of the executed task.
    ...
    def on_retry(self, exc, taREDACTEDid, args, kwargs, einfo):
        """Retry handler.
        ...
        Arguments:
            ...
            taREDACTEDid (str): Unique id of the retried task.
    ...
    def on_failure(self, exc, taREDACTEDid, args, kwargs, einfo):
        """Error handler.
        ...
        Arguments:
            ...
            taREDACTEDid (str): Unique id of the failed task.
    ...
    def after_return(self, status, retval, taREDACTEDid, args, kwargs, einfo):
        """Handler called after the task returns.

        Arguments:
            status (str): Current task state.
            retval (Any): Task return value/exception.
            taREDACTEDid (str): Unique id of the task.
