...
class Settings(ConfigurationView):
    ...
    @property
    def taREDACTEDdefault_exchange(self):
        return self.first(
            'taREDACTEDdefault_exchange',
            'taREDACTEDdefault_queue',
        )

    @property
    def taREDACTEDdefault_routing_key(self):
        return self.first(
            'taREDACTEDdefault_routing_key',
            'taREDACTEDdefault_queue',
        )
