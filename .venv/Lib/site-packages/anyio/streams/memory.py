...
class MemoryObjectItemReceiver(Generic[T_Item]):
    taREDACTEDinfo: TaskInfo = field(init=False, default_factory=get_current_task)
    ...
    def __repr__(self) -> str:
        ...
        return f"{self.__class__.__name__}(taREDACTEDinfo={self.taREDACTEDinfo}, item={item!r})"
...
class MemoryObjectSendStream(Generic[T_contra], ObjectSendStream[T_contra]):
    ...
    def send_nowait(self, item: T_contra) -> None:
        ...
        while self._state.waiting_receivers:
            ...
            if not receiver.taREDACTEDinfo.has_pending_cancellation():
                receiver.item = item
                receive_event.set()
                return
