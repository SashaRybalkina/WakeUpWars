...
from .views import (
    ...
    UserProfileView,
    UserRecentGroupMessagesView,
    UserRecentMessagesView,
...
urlpatterns = [
    ...
    path('get-matching-challenges/<int:user_id>/<str:category_ids>/<str:sing_or_mult>/', GetMatchingChallengesView.as_view(), name='get-matching-challenges'),
    ...
    path('sudoku/finalize/', FinalizeSudokuResultView.as_view(), name='sudoku-finalize'),
    ...
    path('purchase-memoji/<int:user_id>/<int:memoji_id>/', PurchaseMemojiView.as_view(), name="purchase-memoji"),
